                    ...
                    <ul class="adding-post__tabs-list filters__list tabs__list">
                        <?php foreach ($types as $type): ?>
                            <li class="adding-post__tabs-item filters__item">
                                ...
                                >
                                    <svg class="filters__icon" width="<?= $type['width'] ?>"
                                         height="<?= $type['height'] ?>">
                        ...
                        <form class="adding-post__form form" action="add.php" method="post"
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <input class="adding-post__input-file form__input-file" id="file" type="file"
                                           name="file" title=" ">
                                </div>
                            </div>
                            <div class="adding-post__buttons">
                                <button class="adding-post__submit button button--main" type="submit" id="photo-submit">
                                    Опубликовать
                                </button>
                        ...
                        <form class="adding-post__form form" action="add.php" method="post"
                            ...
                            <div class="form__text-inputs-wrapper">
                                <div class="form__text-inputs">
                                    ...
                                    <div class="adding-post__input-wrapper form__input-wrapper">
                                        <label class="adding-post__label form__label"
                                               for="video-url"><?= $label['video-url']; ?> <span
                            ...
                            <div class="form__text-inputs-wrapper">
                                <div class="form__text-inputs">
                                    ...
                                    <div class="adding-post__textarea-wrapper form__textarea-wrapper">
                                        <label class="adding-post__label form__label"
                                               for="post-text"><?= $label['post-text']; ?> <span
                                                class="form__input-required">*</span></label>
                            ...
                            <div class="form__text-inputs-wrapper">
                                <div class="form__text-inputs">
                                    ...
                                    <div class="adding-post__input-wrapper form__textarea-wrapper">
                                        <label class="adding-post__label form__label"
                                               for="quote-text"><?= $label['quote-text']; ?> <span
                                                class="form__input-required">*</span></label>
                                        <div class="form__input-section  <?php if (isset($errors['quote-text'])) {
                                            ...
                                            <textarea
                                                ...
                                                placeholder="Текст цитаты"><?= get_post_value('quote-text'); ?></textarea>
                                            <button class="form__error-button button" type="button">!<span
                                                    class="visually-hidden">Информация об ошибке</span></button>
                                            <div class="form__error-text">
                                    ...
                                    <div class="adding-post__textarea-wrapper form__input-wrapper">
                                        <label class="adding-post__label form__label"
                                               for="quote-author"><?= $label['quote-author']; ?> <span
                                                class="form__input-required">*</span></label>
                        ...
                        <form class="adding-post__form form" action="add.php" method="post">
                            <div class="form__text-inputs-wrapper">
                                <div class="form__text-inputs">
                                    ...
                                    <div class="adding-post__textarea-wrapper form__input-wrapper">
                                        <label class="adding-post__label form__label"
                                               for="post-link"><?= $label['post-link']; ?> <span
                                                class="form__input-required">*</span></label>
