<main class="page__main page__main--login">
    ...
    echo 'form__input-section--error';
                            ...
                            <input class="login__input form__input" id="login-email" type="email" name="login" placeholder="Укажите эл.почту" value="<?=get_post_value('login')?>">
    ...
    echo 'form__input-section--error';
                            ...
                            <input class="login__input form__input" id="login-password" type="password" name="password" placeholder="Введите пароль" value="<?=get_post_value('password') ?>">
