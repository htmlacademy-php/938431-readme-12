                                       ...
                                       title="Перейти по ссылке">
                                        <div class="post-link__info-wrapper">
                                            <div class="post-link__icon-wrapper">
                                                <img src="<?= generate_favicon_url($post['post_url']); ?>" width="16"
                                                     height="16" alt="Иконка">
                                            </div>
                        ...
                        <div class="post__author">
                            <a class="post__author-link" href="/profile.php?id=<?= $post['user_id'] ?>" title="Автор">
                                ...
                                <div class="post__info">
                                    ...
                                    <time class="post__time" datetime="<?= $post['post_date']; ?>"
                                          title="<?= format_date($post['post_date']); ?>"><?= generate_passed_time_text($post['post_date']); ?>
                                        назад
                                    </time>
                                </div>
                            </a>
