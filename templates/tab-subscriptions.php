    ...
    <ul class="profile__subscriptions-list">
        ...
        <div class="post-mini__user-info user__info">
            ...
            <a class="user__avatar-link" href="/profile.php?id=<?=$user['user_id']?>">
                <?php if ($user['avatar']): ?>
                <img class="post-mini__picture user__picture" src="<?=$user['avatar']?>" width="60" height="60" alt="Аватар пользователя">
                <?php endif; ?>
            </a>
            </div>
        ...
        <div class="post-mini__rating user__rating">
            ...
            <span class="post-mini__rating-amount user__rating-amount"><?=$user['subscriber_count'] ?? 0; ?></span>
