<section class="profile__subscriptions tabs__content tabs__content--active">
    ...
    <ul class="profile__subscriptions-list">
        ...
        <div class="post-mini__user-info user__info">
            ...
            <a class="user__avatar-link" href="/profile.php?id=<?=$user['id']?>">
                <img class="post-mini__picture user__picture" src="<?=$user['u_avatar']?>" width="60" height="60" alt="Аватар пользователя">
            </a>
            </div>
            <div class="post-mini__name-wrapper user__name-wrapper">
            <a class="post-mini__name user__name" href="/profile.php?id=<?=$user['id']?>">
        ...
        <div class="post-mini__user-buttons user__buttons">
            <a class="post-mini__user-button user__button user__button--subscription button <?=$user['is_in_subs'] ? 'button--quartz' : 'button--main'; ?>" href="/subscribe.php?id=<?=$user['id']?>">
