                    ...
                    <div class="post-mini__user-info user__info">
                      <div class="post-mini__avatar user__avatar">
                        <a class="user__avatar-link" href="/profile.php?id=<?=$post['like_user'];?>">
                          <?php if ($post['avatar']): ?>
                          <img class="post-mini__picture user__picture" src="<?=$post['avatar'];?>" width="60" heigth="60" alt="Аватар пользователя">
                          <?php endif; ?>
                        </a>
                      </div>
                      <div class="post-mini__name-wrapper user__name-wrapper">
                        ...
                        <div class="post-mini__action">
                          ...
                          <time class="post-mini__time user__additional" datetime="<?=$post['like_date'];?>"><?= generate_passed_time_text($post['like_date']);?> назад</time>
                        </div>
                      </div>
                    </div>
                    <div class="post-mini__preview">
                      ...
                      <!-- Фото -->
                        <div class="post-mini__image-wrapper">
                          <img class="post-mini__image" src="<?=$post['post_url'];?>" width="109" height="109" alt="Превью публикации">
                        </div>
